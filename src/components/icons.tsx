...
export const Award = (p: IconProps) => (
  <svg {...base(p)}><circle cx="12" cy="8" r="6"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg>
);
...
export const Building = (p: IconProps) => (
  <svg {...base(p)}><rect x="4" y="2" width="16" height="20" rx="2"/><line x1="9" y1="22" x2="9" y2="18"/><line x1="15" y1="22" x2="15" y2="18"/><line x1="8" y1="6" x2="10" y2="6"/><line x1="14" y1="6" x2="16" y2="6"/><line x1="8" y1="10" x2="10" y2="10"/><line x1="14" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="10" y2="14"/><line x1="14" y1="14" x2="16" y2="14"/></svg>
);
export const GraduationCap = (p: IconProps) => (
  <svg {...base(p)}><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 1.7 3.6 3 6 3s6-1.3 6-3v-5"/></svg>
);
...
export const Sparkles = (p: IconProps) => (
  <svg {...base(p)}><path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5L12 3z"/><path d="M19 14l.7 2.1L22 17l-2.3.9L19 20l-.7-2.1L16 17l2.3-.9L19 14z"/></svg>
);
...
export const Globe = (p: IconProps) => (
  <svg {...base(p)}><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 3 0 0 1 4-10z"/></svg>
);
export const FlaskConical = (p: IconProps) => (
  <svg {...base(p)}><path d="M9 3h6"/><path d="M10 3v6.5L4.5 19a2 2 0 0 0 1.7 3h11.6a2 2 0 0 0 1.7-3L14 9.5V3"/><path d="M7.5 14h9"/></svg>
);
...
export const LogIn = (p: IconProps) => (
  <svg {...base(p)}><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>
);
...
export const UserCog = (p: IconProps) => (
  <svg {...base(p)}><circle cx="9" cy="7" r="4"/><path d="M3 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/><circle cx="18" cy="15" r="3"/><path d="M21.7 16.4l-.5-.3"/><path d="M15 13.6l-.5.3"/><path d="M16.6 11.3l-.3.5"/><path d="M19.4 18.7l-.3-.5"/><path d="M19.4 11.3l-.3.5"/><path d="M16.6 18.7l-.3-.5"/><path d="M21.7 13.6l-.5-.3"/><path d="M15 16.4l-.5.3"/></svg>
);
